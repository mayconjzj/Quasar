...
export const Container = tw.main`mt-[70px] pb-8 md:px-8 px-2 flex flex-col gap-4 max-w-[1200px] m-auto`;
...
export const SearchResultsItem = tw.div`flex gap-x-4 gap-y-2`;
export const Details = tw.div`flex flex-col gap-1 relative w-full`;
